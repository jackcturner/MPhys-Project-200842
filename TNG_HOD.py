...
subhalos['BMass'] = BMass

# Adding index column to join on halos table.
subhalos['GroupFirstSub'] = range(0,len(subhalos))

# Converting units to Msun/h.
subhalos['BMass'] = subhalos['BMass'].apply(lambda x: np.log10(x*(1e10)*1.4))

# Applying galaxy stellar mass limit.
sat_subhalos = subhalos.loc[subhalos['BMass'] > s_mass]
subhalos = subhalos.loc[subhalos['BMass'] > g_mass]
